...
exports.CreateIngredient=async function (req, res, next) {
    try {
        ...
        const newIngredient = await IngredientsRepository.createIngredient(data, brandID);
        return res.json(ApiSuccess.created("Ingredient created successfully", newIngredient));
      } catch (error) {
        return next(error);
      }
}
...
exports.AddIngredientTransaction=async function (req, res, next){
    ...
    try {
        ...
        data.type="extra"
        const newIngredientTransaction = await IngredientsRepository.addIngredientTransaction(data, userID, { transaction: t });
        await IngredientsRepository.updateIngredientStock(data.ingredient_id, data.quantity, { transaction: t });
        await t.commit();
        return res.json(ApiSuccess.created("Ingredient transaction created successfully", newIngredientTransaction));
      } catch (error) {
        if (!t.finished) {
            await t.rollback();
        }
...
exports.UpdateIngredient=async function (req, res, next){
    try {
        ...
        const updateIngredient = await IngredientsRepository.updateIngredient(ingredientID, data);
        return res.json(ApiSuccess.updated("Ingredient updated successfully", updateIngredient));
      } catch (error) {
        return next(error);
      }
}
...
exports.DeleteIngredient=async function (req, res, next){
    try {
        ...
        const deleteIngredient = await IngredientsRepository.deleteIngredient(ingredientID);
        return res.json(ApiSuccess.deleted("Ingredient deleted successfully", deleteIngredient));
      } catch (error) {
        return next(error);
      }
}
...
exports.GetIngredient=async function (req, res, next){
    try {
        ...
        const getIngredient = await IngredientsRepository.getIngredient(ingredientID);
        return res.json(ApiSuccess.getSelect("Ingredient retrieved successfully", getIngredient));
      } catch (error) {
        return next(error);
      }
}
